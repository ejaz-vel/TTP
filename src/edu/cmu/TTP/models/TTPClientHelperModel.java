 ...
 * @author apurv
 *
 *         Model class which contains fields to support the client side
 *         connection
 */
public class TTPClientHelperModel {
	...
	public String toString() {
		return "TTPClientHelperModel [ttpService=" + ttpService + ", ackReceived="
				+ ackReceived + ", numberOfSegmentsToBeReceived="
				+ numberOfSegmentsToBeReceived + ", expectedSequenceNumber="
